...
import { Battery, Brain, Scale, Sunrise, ArrowRight, PauseCircle } from 'lucide-react';
    ...
    <div className="space-y-6 md:space-y-8 animate-fade-in">
      ...
      <section className="flex flex-col md:flex-row md:items-end md:justify-between border-b border-slate-100 pb-6 md:pb-8">
        <div>
          ...
          <p className="text-slate-500 text-base md:text-lg">Here is how your system looks today.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
        ...
        {/* Left Column: System State (Takes up more space on large screens) */}
