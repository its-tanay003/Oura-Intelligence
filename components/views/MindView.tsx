  ...
  if (step === 1) {
    return (
      <div className="max-w-2xl mx-auto pb-6 animate-fade-in">
        <button 
          onClick={() => setStep(0)} 
          className="group flex items-center gap-2 text-slate-400 text-sm mb-6 hover:text-slate-600 px-2 py-2 -ml-2 rounded-lg hover:bg-slate-100/50 transition-all"
        >
